<template>
    <div class="col-lg-4 col-sm-6 mb-4">
        <div class="portfolio-item">
            <router-link class="portfolio-link" data-toggle="modal" :to="getCategoryUrl(id)">
                ...
                <img class="img-fluid" :src="getCategoryImage(imagePath)" alt="">
            </router-link>
